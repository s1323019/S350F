                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select  class="form-select" name="courseId"  id="courseId" aria-label="Category" id="courseId"  required>
                                <option selected>select course</option>
                                <option value="COMPS312F">COMPS312F</option>
                                <option value="COMPS350F">COMPS350F</option>
                                <option value="COMPS381F">COMPS381F</option>
                                <option value="COMPS320F">COMPS320F</option>
                                </select>
