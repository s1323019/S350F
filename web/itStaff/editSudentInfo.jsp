        ...
        <form  method="get" action="StudentInfoController" id="myForm">
            <div style="width: 24rem;" class="center-div">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="Email" aria-describedby="emailHelp" name="pEmail" value="<%= rs.getString(4)%>" disabled  disabled>
                </div>                
                <div class="mb-3">
                ...
                <%
                    ...
                    ps = ct.prepareStatement("select * from student_account sa ,student s  where s.stu_id = ? and s.stu_aid = sa.stu_aid");
                    ps.setString(1, sId);
                    rs = ps.executeQuery();
                    rs.next();
                %>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="LoginID" aria-describedby="emailHelp" value="<%= rs.getString(1)%>" name="LoginID" disabled>
                </div>
                <div class="mb-3">
                    <label for="Password">Password</label>
                    <input type="text" class="form-control" id="Year" aria-describedby="Password" value="<%= rs.getString(2)%>" name="Password"  disabled>
                </div>
...
<script>
    ...
    function enableInputs() {
        ...
        let LoginID = document.getElementsByTagName("LoginID");
